...
/**
 * Get the Daily Check definition for a specific language.
 */
...
/**
 * Get the Daily Check definition using the current app language.
 */
 ...
 */
export const dailyCheck = getDefinition('de');
