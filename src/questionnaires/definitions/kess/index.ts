/**
 * KESS (Knowles-Eccersley-Scott Symptom Score) Questionnaire Definition
 *
...
/**
 * Get the KESS definition for a specific language.
 */
...
/**
 * Get the KESS definition using the current app language.
 */
 ...
 */
export const kess = getDefinition('de');
