...
const ROLES: RoleConfig[] = [
    ...
    { role: 'caregiver', labelKey: 'onboarding.sharing.caregiver', descKey: 'onboarding.sharing.caregiverLockedDesc' },
    { role: 'research', labelKey: 'onboarding.sharing.research', descKey: 'onboarding.sharing.researchDesc' }
];

export default function ManagedSharingScreen() {
                ...
                >
                    <ScrollViewContent>
                        <ScreenHeader
                            ...
                            subtitle={ t('onboarding.sharing.subtitleCaregiver') }
                        />
